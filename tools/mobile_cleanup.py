...
CSS = ROOT / "mobile-responsive.css"

CSS.write_text(r'''
/* GIndia Kids - site-wide mobile/scroll safety */
html, body { width:100%; max-width:100%; min-height:100%; }
html { overflow-x:hidden !important; overflow-y:auto !important; }
body { overflow-x:hidden !important; overflow-y:auto !important; min-height:100svh; }
...
@media (max-width: 768px) {
  ...
  .hero { width:100% !important; max-width:100% !important; padding-left:12px !important; padding-right:12px !important; }
  .section, .wrap, .container, .content { width:100% !important; max-width:100% !important; padding-left:10px !important; padding-right:10px !important; }
  .grid, .cats { grid-template-columns:repeat(2,minmax(0,1fr)) !important; gap:10px !important; }
  .learning { grid-template-columns:1fr !important; }
  .card, .cat, .learn, .story { min-width:0 !important; }
...
@media (max-width: 480px) {
  ...
  .card, .cat { padding:14px !important; }
